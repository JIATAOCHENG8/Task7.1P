...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void updateNote(Note note) {
        ...
        ContentValues contentValues = new ContentValues();
        contentValues.put(Util.NOTE_TITLE, note.getNote_title());
        db.update(Util.TABLE_NAME, contentValues, Util.NOTE_TITLE + " =? ", new String[]{String.valueOf(note.getNote_title())});
    }

    public void deleteNote(Note note)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(Util.TABLE_NAME, Util.NOTE_TITLE + " =? " , new String[]{String.valueOf(note.getNote_title())});
